...
<body
    class="min-h-screen bg-gradient-to-br from-primary/5 via-accent to-secondary/5 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        {{-- Header --}}
        <div class="text-center">
            <div
                class="mx-auto w-24 h-24 flex items-center justify-center">
                <a href="{{ url('/') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    d="M6 8V7C6 5.9 6.9 5 8 5H16C17.1 5 18 5.9 18 7V8H19C19.6 8 20 8.4 20 9V19C20 19.6 19.6 20 19 20H5C4.4 20 4 19.6 4 19V9C4 8.4 4.4 8 5 8H6M8 7V8H16V7C16 6.4 15.6 6 15 6H9C8.4 6 8 6.4 8 7Z" />
                            </svg>
                        </div>
                ...
                <div>
                    <button type="submit"
                        ...
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-white/80 group-hover:text-white" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                                    d="M10,17V14H3V10H10V7L15,12L10,17M10,2H19A2,2 0 0,1 21,4V20A2,2 0 0,1 19,22H10C8.89,22 8,21.1 8,20V18H10V20H19V4H10V6H8V4A2,2 0 0,1 10,2Z" />
                            </svg>
                        </span>
                        Access Admin Portal
                    </button>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('admin.register') }}"
                            class="font-semibold text-primary hover:text-secondary transition duration-150 ease-in-out">
                            Request Account
                        </a>
                    </p>
                </div>
        ...
        <div class="text-center">
            <a href="{{ url('/') }}"
                class="inline-flex items-center text-sm text-gray-500 hover:text-primary transition duration-150 ease-in-out">
