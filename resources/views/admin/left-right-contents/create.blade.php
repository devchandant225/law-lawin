...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-white">Add New Left-Right Content for: {{ $post->title }}</h1>
    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6 max-w-3xl mx-auto">
        <form action="{{ route('admin.posts.left-right-contents.store', $post->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
