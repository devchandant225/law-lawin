    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.pages.show', $page) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title', $page->title) }}" required onkeyup="generateSlug()"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="slug" name="slug" value="{{ old('slug', $page->slug) }}" placeholder="Auto-generated from title"
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3" placeholder="Short summary of the page"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('excerpt') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('excerpt', $page->excerpt) }}</textarea>
                                @error('excerpt')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="8"
                                          ...
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description', $page->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="metatitle" name="metatitle" value="{{ old('metatitle', $page->metatitle) }}" maxlength="255" placeholder="Up to 60 characters recommended"
                            ...
                            <div>
                                ...
                                <textarea id="metadescription" name="metadescription" rows="3" maxlength="500" placeholder="Up to 160 characters recommended"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('metadescription') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('metadescription', $page->metadescription) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" id="metakeywords" name="metakeywords" value="{{ old('metakeywords', $page->metakeywords) }}" placeholder="keyword1, keyword2, keyword3"
                        ...
                        <div class="p-4">
                            <div>
                                ...
                                <textarea id="json_ld_schema" name="json_ld_schema" rows="8" placeholder="Enter valid JSON-LD schema"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('json_ld_schema') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('json_ld_schema', is_array($page->json_ld_schema) ? json_encode($page->json_ld_schema, JSON_PRETTY_PRINT) : '') }}</textarea>
                ...
                <div class="lg:col-span-1">
                    <div class="lg:sticky lg:top-4 space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" required
                                        ...
                                        @foreach($types as $key => $value)
                                            <option value="{{ $key }}" {{ old('type', $page->type) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" required
                                        ...
                                        @foreach($statuses as $key => $value)
                                            <option value="{{ $key }}" {{ old('status', $page->status) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                            <div class="px-4 py-3 border-b border-gray-200">
                                <h5 class="font-semibold text-gray-900">{{ $page->feature_image ? 'Update' : 'Upload' }} Featured Image</h5>
                            </div>
                            <div class="p-4 space-y-4">
                                <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="feature_image_alt" name="feature_image_alt" value="{{ old('feature_image_alt', $page->feature_image_alt) }}" placeholder="Describe the image for SEO"
...
function generateSchema() {
    ...
    const schema = {
        ...
        "description": excerpt || "{{ $page->excerpt }}",
