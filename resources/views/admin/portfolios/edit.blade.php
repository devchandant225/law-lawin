    ...
    <div>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update the portfolio item details.</p>
            </div>
                    ...
                    <div>
                        ...
                        @if($portfolio->image)
                            <div class="mb-4">
                                ...
                                <img src="{{ $portfolio->image_url }}" alt="{{ $portfolio->title }}" class="w-32 h-32 rounded-lg object-cover border border-gray-200">
                            </div>
                        @endif
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-xs text-gray-500">Accepted formats: JPEG, PNG, WebP, GIF. Max size: 2MB. Leave empty to keep current image.</p>
                            </div>
                        </div>
                        @error('image')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
