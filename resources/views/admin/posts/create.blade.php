                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="lg:col-span-1">
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" required
                                        ...
                                        <option value="team_page" {{ old('type') == 'team_page' ? 'selected' : '' }}>Team Page</option>
                                    </select>
                                    @error('type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="layout" name="layout" required
                                            class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('layout') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">
                                        <option value="with_sidebar" {{ old('layout', 'with_sidebar') == 'with_sidebar' ? 'selected' : '' }}>With Sidebar</option>
                                        <option value="fullscreen" {{ old('layout') == 'fullscreen' ? 'selected' : '' }}>Fullscreen</option>
                                    </select>
                                    @error('layout')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                            ...
                            <div class="p-4 space-y-4">
                                <div class="mb-3">
                                    <label for="icon" class="block text-sm font-medium text-gray-700 mb-1">Upload Icon</label>
