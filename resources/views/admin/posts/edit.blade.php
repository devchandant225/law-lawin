                            ...
                            <div class="p-4">
                                <div>
                                    ...
                                    <textarea id="google_schema" name="google_schema" rows="8" placeholder="Enter valid JSON-LD schema"
                                              class="block w-full rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 @error('google_schema') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('google_schema', $post->google_schema ? json_encode($post->google_schema, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : '') }}</textarea>
                                    @error('google_schema')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
