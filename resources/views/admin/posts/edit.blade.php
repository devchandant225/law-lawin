                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    ...
                                    <textarea id="schema_head" name="schema_head" rows="6" placeholder="Enter valid JSON-LD schema for <head>"
                                              class="block w-full rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 @error('schema_head') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('schema_head', $post->schema_head ? json_encode($post->schema_head, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : '') }}</textarea>
                                    @error('schema_head')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <textarea id="schema_body" name="schema_body" rows="6" placeholder="Enter valid JSON-LD schema for end of <body>"
                                              class="block w-full rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 @error('schema_body') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('schema_body', $post->schema_body ? json_encode($post->schema_body, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : '') }}</textarea>
                                    @error('schema_body')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
