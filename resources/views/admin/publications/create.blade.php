                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="post_type" name="post_type" required
                                            ...
                                            <option value="publication" {{ old('post_type') == 'publication' ? 'selected' : '' }}>Publication</option>
                                            <option value="more-publication" {{ old('post_type') == 'more-publication' ? 'selected' : '' }}>More Publication</option>
                                            <option value="study-abroad" {{ old('post_type') == 'study-abroad' ? 'selected' : '' }}>Study Abroad</option>
                                            <option value="learning-center" {{ old('post_type') == 'learning-center' ? 'selected' : '' }}>Learning Center</option>
                                            <option value="service-location" {{ old('post_type') == 'service-location' ? 'selected' : '' }}>Service Location</option>
                                            <option value="language" {{ old('post_type') == 'language' ? 'selected' : '' }}>Language</option>
                                        </select>
                                        @error('post_type')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="p-4 space-y-4">
                                    <div class="mb-3">
                                        <label for="feature_image"
                                            class="block text-sm font-medium text-gray-700 mb-1">Upload Image</label>
