                                ...
                                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="text" id="title" name="title" value="{{ old('title') }}"
                                            required onkeyup="generateSlug()" placeholder="Enter publication title"
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div>
                                    <label for="metatitle" class="block text-sm font-medium text-gray-700 mb-1">Meta
                                        Title</label>
                                    <input type="text" id="metatitle" name="metatitle" value="{{ old('metatitle') }}"
                                        maxlength="255" placeholder="Up to 60 characters recommended"
                                ...
                                <div>
                                    <label for="metadescription" class="block text-sm font-medium text-gray-700 mb-1">Meta
                                        Description</label>
                                    <textarea id="metadescription" name="metadescription" rows="3" maxlength="500"
                                        placeholder="Up to 160 characters recommended"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="metakeywords" name="metakeywords"
                                        value="{{ old('metakeywords') }}" placeholder="keyword1, keyword2, keyword3"
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="post_type" name="post_type" required
                                            ...
                                            <option value="publication"
                                                {{ old('post_type', 'publication') == 'publication' ? 'selected' : '' }}>Publication</option>
                                            <option value="more-publication" {{ old('post_type') == 'more-publication' ? 'selected' : '' }}>
                                                More Publication</option>
                                            <option value="terms-condition" {{ old('post_type') == 'terms-condition' ? 'selected' : '' }}>
                                                Terms & Conditions</option>
                                            <option value="privacy-policy" {{ old('post_type') == 'privacy-policy' ? 'selected' : '' }}>
                                                Privacy Policy</option>
                                            <option value="cookies-policy" {{ old('post_type') == 'cookies-policy' ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="orderlist" name="orderlist"
                                            value="{{ old('orderlist', 0) }}" min="0" max="9999"
                                ...
                                <div class="p-4 space-y-4">
                                    <div class="mb-3">
                                        <label for="feature_image"
                                            class="block text-sm font-medium text-gray-700 mb-1">Upload Image (Optional)</label>
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">Supported formats: JPEG, PNG, JPG, GIF, WebP
                                            (Max: 2MB). If no image is uploaded, a gradient background will be displayed.</p>
                                    </div>

                                    <div class="mb-3">
                                        <label for="feature_image_alt" class="block text-sm font-medium text-gray-700 mb-1">Image Alt Text</label>
                                        <input type="text" id="feature_image_alt" name="feature_image_alt" value="{{ old('feature_image_alt') }}"
