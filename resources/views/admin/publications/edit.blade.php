    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.publications.show', $publication) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-sky-300 text-sky-700 hover:bg-sky-50">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title', $publication->title) }}" required onkeyup="generateSlug()"
                                           placeholder="Enter publication title" maxlength="120" data-count="title-count" data-max="120"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="slug" name="slug" value="{{ old('slug', $publication->slug) }}" placeholder="Auto-generated from title"
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3" placeholder="Short summary of the publication" maxlength="200" data-count="excerpt-count" data-max="200"
                    ...
                    <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="metatitle" name="metatitle" value="{{ old('metatitle', $publication->metatitle) }}" maxlength="60" data-count="meta-title-count" data-max="60" placeholder="Up to 60 characters"
                            ...
                            <div>
                                ...
                                <textarea id="metadescription" name="metadescription" rows="3" maxlength="160" data-count="meta-desc-count" data-max="160" placeholder="Up to 160 characters recommended"
                            ...
                            <div>
                                ...
                                <input type="text" id="metakeywords" name="metakeywords" value="{{ old('metakeywords', $publication->metakeywords) }}" placeholder="keyword1, keyword2, keyword3"
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" required
                                        ...
                                        <option value="active" {{ old('status', $publication->status) == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="inactive" {{ old('status', $publication->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" id="orderlist" name="orderlist" value="{{ old('orderlist', $publication->orderlist) }}" min="0" max="9999"
                                ...
                                <!-- Publication Dates -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Publication Information</label>
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                @if($publication->feature_image)
                                    <div>
                                        ...
                                        <img src="{{ $publication->feature_image_url }}" alt="{{ $publication->title }}" class="rounded border border-gray-200 max-h-52">
                                    </div>
                                @endif

                                <div>
                                    <label for="feature_image" class="block text-sm font-medium text-gray-700 mb-1">{{ $publication->feature_image ? 'Change Image' : 'Upload Image' }}</label>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
                            <div class="p-4">
                                <div class="grid gap-2">
                                    ...
                                    <a href="{{ route('admin.publications.show', $publication) }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-sky-300 text-sky-700 hover:bg-sky-50">
                                        <i class="fas fa-eye"></i>
                                        <span>View Publication</span>
                                    </a>
