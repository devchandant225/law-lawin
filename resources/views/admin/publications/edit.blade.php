                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                            ...
                            <div class="p-4 space-y-6">
                                <x-schema-repeater name="schema_head" label="Schema JSON-LD (Head)" :data="$publication->schema_head" />
                                <x-schema-repeater name="schema_body" label="Schema JSON-LD (Body)" :data="$publication->schema_body" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="feature_image_alt" name="feature_image_alt" value="{{ old('feature_image_alt', $publication->feature_image_alt) }}"
