                        ...
                        <div class="p-4 space-y-4">
                            <div>
                                ...
                                <textarea id="schema_head" name="schema_head" rows="8" placeholder="Enter valid JSON-LD schema for head section"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('schema_head') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('schema_head') }}</textarea>
                                @error('schema_head')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <textarea id="schema_body" name="schema_body" rows="8" placeholder="Enter valid JSON-LD schema for body section"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('schema_body') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('schema_body') }}</textarea>
                                @error('schema_body')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="image_alt" name="image_alt" value="{{ old('image_alt') }}" placeholder="Describe the image for SEO"
...
function generateSchema(targetId) {
    ...
    const slug = document.getElementById('slug').value || 'member-slug';
