    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.teams.show', $team) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-sky-300 text-sky-700 hover:bg-sky-50">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', $team->name) }}" required onkeyup="generateSlug()"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="slug" name="slug" value="{{ old('slug', $team->slug) }}" placeholder="Auto-generated from name"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email', $team->email) }}" placeholder="email@example.com"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="phone" name="phone" value="{{ old('phone', $team->phone) }}" placeholder="+1234567890"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="designation" name="designation" value="{{ old('designation', $team->designation) }}" placeholder="e.g., Senior Partner"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="orderlist" name="orderlist" value="{{ old('orderlist', $team->orderlist) }}" min="0"
                            ...
                            <div>
                                ...
                                <input type="text" id="tagline" name="tagline" value="{{ old('tagline', $team->tagline) }}" placeholder="Brief professional tagline"
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="6" placeholder="Detailed bio and description..."
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description', $team->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="experience" name="experience" rows="4" placeholder="Professional experience and achievements..."
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('experience') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('experience', $team->experience) }}</textarea>
                                @error('experience')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="qualification" name="qualification" rows="4" placeholder="Educational qualifications and certifications..."
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('qualification') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('qualification', $team->qualification) }}</textarea>
                                @error('qualification')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="additional_details" name="additional_details" rows="4" placeholder="Any additional information..."
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('additional_details') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('additional_details', $team->additional_details) }}</textarea>
                        ...
                        <div class="p-4 space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="url" id="linkedinlink" name="linkedinlink" value="{{ old('linkedinlink', $team->linkedinlink) }}" placeholder="https://linkedin.com/in/username"
                                ...
                                <div>
                                    ...
                                    <input type="url" id="facebooklink" name="facebooklink" value="{{ old('facebooklink', $team->facebooklink) }}" placeholder="https://facebook.com/username"
                    ...
                    <div class="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="metatitle" name="metatitle" value="{{ old('metatitle', $team->metatitle) }}" maxlength="255" placeholder="Up to 60 characters recommended"
                            ...
                            <div>
                                ...
                                <textarea id="metadescription" name="metadescription" rows="3" maxlength="500" placeholder="Up to 160 characters recommended"
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 @error('metadescription') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('metadescription', $team->metadescription) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" id="metakeywords" name="metakeywords" value="{{ old('metakeywords', $team->metakeywords) }}" placeholder="keyword1, keyword2, keyword3"
                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    ...
                                    <select id="status" name="status" required
                                        ...
                                        <option value="draft" {{ old('status', $team->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500 space-y-1">
                                        <div>Created: {{ $team->created_at->format('M d, Y \a\t g:i A') }}</div>
                                        <div>Updated: {{ $team->updated_at->format('M d, Y \a\t g:i A') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                @if($team->image)
                                    <div>
                                        ...
                                        <img src="{{ $team->image_url }}" alt="{{ $team->name }}" class="rounded border border-gray-200 max-h-52">
                                    </div>
                                @endif

                                <div>
                                    <label for="image" class="block text-sm font-medium text-gray-700 mb-1">{{ $team->image ? 'Change Image' : 'Upload Image' }}</label>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
                            <div class="p-4">
                                <div class="grid gap-2">
                                    ...
                                    <a href="{{ route('admin.teams.show', $team) }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-sky-300 text-sky-700 hover:bg-sky-50">
                                        <i class="fas fa-eye"></i>
                                        <span>View Member</span>
                                    </a>
...
function generateSchema() {
    ...
    const email = document.getElementById('email').value || '{{ $team->email }}';
    const phone = document.getElementById('phone').value || '{{ $team->phone }}';
    const linkedinlink = document.getElementById('linkedinlink').value || '{{ $team->linkedinlink }}';
    const facebooklink = document.getElementById('facebooklink').value || '{{ $team->facebooklink }}';
    ...
    const schema = {
        ...
        "description": tagline,
        "url": window.location.origin + "/team/{{ $team->slug }}"
    };
