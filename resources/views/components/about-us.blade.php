            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="about-one__image wow fadeInLeft " data-wow-delay="00ms">
                        <img src="{{ asset('storage/' . $intro_home->image1) }}" alt="{{ $intro_home->title }}">
                    ...
                    <div class="about-one__inner">
                        <div class="about-one__content">
                            <div class="sec-title text-left">
                                ...
                                <div
                                    class="sec-title__tagline bw-split-in-up-fast d-inline-flex align-items-center gap-2">
                                    <div>
                                        <svg class="hammer" width="23" height="23" viewBox="0 0 23 23"
                            ...
                            <div class="about-one__content__box">
                                <div class="d-flex flex-column justify-content-between align-items-start">
                                    <a href="/about" class="procounsel-btn"><i>Discover More</i><span>Discover
                                            More
                                        </span>
                                    </a>
                                </div>
    ...
    <section class="logos-why-choose">
        <div class="logos-why-choose__bg jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%"
            style="background-image: url({{ asset('storage/' . $why_choose_home->image1) }});"></div>

        <div class="logos-why-choose__benefits">
            <div class="logos-why-choose__benefits__bg"
                style="background-image: url({{ asset('storage/' . $why_choose_home->image2) }});"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="sec-title text-left">
