...
<section class="relative py-8 overflow-hidden bg-white" id="contact" data-aos="fade-up" data-aos-duration="800">
    <div class="container mx-auto px-4 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            <div class="space-y-8 bg-gradient-to-br from-[#108fcc] to-[#d0700b] px-8 py-8 rounded-2xl shadow-xl" data-aos="fade-right" data-aos-delay="200">
                <!-- Header -->
                <div class="space-y-6">
            ...
            @if ($showForm)
                <div class="space-y-4" data-aos="fade-left" data-aos-delay="300">
                    ...
                    <div class="bg-gray-100 rounded-2xl shadow-xl p-8">
                        <div class="mb-6">
                            <h3 class="text-2xl font-bold text-[#d0700b] mb-2">
