...
<section class="relative bg-gradient-to-br from-gray-50 via-white to-accent overflow-hidden py-20">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-grid-pattern opacity-[0.03]"></div>
    
    <!-- Floating Geometric Shapes -->
    <div class="absolute top-20 left-10 w-32 h-32 border-2 border-primary/20 rounded-full opacity-30 animate-float-slow"></div>
    <div class="absolute bottom-20 right-10 w-24 h-24 border-2 border-secondary/20 rounded-lg opacity-30 animate-float-reverse" style="animation-delay: 2s;"></div>
    <div class="absolute top-1/2 left-1/4 w-16 h-16 border-2 border-primary/20 rotate-45 opacity-30 animate-float-slow" style="animation-delay: 1s;"></div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div class="space-y-8">
                <!-- Contact Info Card -->
                <div class="bg-gradient-to-br from-primary to-secondary p-1 rounded-2xl shadow-2xl transform hover:scale-[1.02] transition-all duration-500">
                    <div class="bg-white rounded-2xl p-8 h-full">
                        ...
                        <div class="space-y-6">
                            <!-- Location -->
                            <div class="group">
                                <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-primary/5 transition-all duration-300 hover:shadow-md">
                                    <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mr-4 group-hover:bg-primary/20 transition-colors duration-300 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 leading-relaxed">{{ $contactInfo['location'] }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Phone -->
                            <div class="group">
                                <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-primary/5 transition-all duration-300 hover:shadow-md">
                                    <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mr-4 group-hover:bg-primary/20 transition-colors duration-300">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:{{ $contactInfo['phone'] }}" class="text-primary font-medium hover:text-secondary transition-colors duration-300">{{ $contactInfo['phone'] }}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="group">
                                <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-primary/5 transition-all duration-300 hover:shadow-md">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:{{ $contactInfo['email'] }}" class="text-primary font-medium hover:text-secondary transition-colors duration-300">{{ $contactInfo['email'] }}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Working Hours -->
                            <div class="group">
                                <div class="p-4 bg-gray-50 rounded-xl hover:bg-primary/5 transition-all duration-300 hover:shadow-md">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100">
                            ...
                            <div class="flex space-x-3">
                                <a href="#" class="w-10 h-10 bg-blue-600 text-white rounded-lg flex items-center justify-center hover:bg-blue-700 transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                    </svg>
                                </a>
                                <a href="#" class="w-10 h-10 bg-blue-800 text-white rounded-lg flex items-center justify-center hover:bg-blue-900 transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="contact-form-container">
                <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 transform hover:shadow-3xl transition-all duration-500">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showSuccessMessage() {
            ...
            message.className = 'fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg z-50 transform translate-x-full opacity-0 transition-all duration-300';
            message.innerHTML = `
