   <section class="contact-two">
       ...
       <img src="assets/images/resources/contact-2-1.png" alt="" class="contact-two__img wow fadeInUp"
           ...
           <div class="row">
               ...
               @if ($showForm)
                   <div class="col-md-6 wow fadeInUp" data-wow-delay="200ms">
                       ...
                       <form class="contact-one__form contact-form-validated form-one" action="{{ $formAction }}"
                           method="POST">
                           @csrf
