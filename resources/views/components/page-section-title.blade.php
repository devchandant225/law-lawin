...
<div class="relative bg-primary py-6 overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
        ...
        <div class="absolute bottom-8 left-8 w-24 h-24 border border-white/20 rounded-full animate-pulse"
            style="animation-delay: 1s;"></div>
        <div class="absolute top-1/2 left-1/4 w-16 h-16 border border-white/10 rounded-full animate-pulse"
            style="animation-delay: 2s;"></div>
        <div class="absolute top-1/4 right-1/4 w-20 h-20 border border-white/10 rounded-full animate-pulse"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            {{-- Main Title --}}
            <span class="text-3xl font-semibold text-white leading-tight tracking-tight uppercase">
