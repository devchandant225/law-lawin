      <section class="testimonials-three" id="testimonial">
            <div class="testimonials-three__bg"
                style="background-image: url(assets/images/shapes/testimonial-bg-3.png);"></div>
            <div class="container">
                <div class="testimonials-three__top">
                    <div class="sec-title text-left">
                        ...
                        <h3 class="sec-title__title bw-split-in-up">See What They Are <br><span>Talking About?</span>
                        </h3><!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
            ...
            <div class="container-fluid">
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms'
