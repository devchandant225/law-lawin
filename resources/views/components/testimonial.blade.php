    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-4xl mx-auto mb-16 text-center">
            <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                What Our <span class="text-secondary">Community</span> Says
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Welcome to our testimonial section, where members of our university community share their experiences
                and insights about life at Forbid Edu Career. We invite you to join us and be part of our inspiring
                journey of...
            </p>
        </div>
        ...
        @if ($testimonials->count() > 0)
            ...
            <div class="testimonial-swiper relative">
                ...
                <button
                    class="testimonial-prev absolute left-4 top-1/2 -translate-y-1/2 z-10 w-14 h-14 rounded-full bg-white shadow-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 hover:shadow-xl transition-all duration-300 group">
                ...
                <button
                    class="testimonial-next absolute right-4 top-1/2 -translate-y-1/2 z-10 w-14 h-14 rounded-full bg-white shadow-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 hover:shadow-xl transition-all duration-300 group">
                    <svg class="w-6 h-6 transform group-hover:translate-x-1 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($testimonials as $testimonial)
                            <div class="swiper-slide">
                                <div
                                    class="testimonial-card bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 mx-3 relative border border-gray-100 group">
                                    ...
                                    <div class="flex justify-center mb-6">
                                        <div class="relative">
                                            ...
                                            <!-- Red Quote Badge -->
                                            <div
                                                class="absolute -bottom-2 -right-2 w-10 h-10 bg-red-500 rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <!-- Testimonial Content -->
                                    <blockquote
                                        class="text-gray-700 text-center leading-relaxed mb-6 relative z-10 font-medium">
                                        "{{ $testimonial->desc }}"
                                    </blockquote>
                                    ...
                                    <!-- Hover Effect Border -->
                                    <div
                                        class="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-blue-100 transition-all duration-500">
                                    </div>
                                </div>
                            </div>
                        @endforeach
