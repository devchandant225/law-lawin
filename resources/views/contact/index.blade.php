...
@section('content')
    ...
    <section class="contact-one">
        <div class="contact-one__bg" style="background-image: url(assets/images/backgrounds/contact-1-bg.jpg);">
        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="sec-title text-left">
                            ...
                            <h3 class="sec-title__title bw-split-in-up">Feel Free to <br><span> Write Us
                                    Anytime</span> </h3><!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
