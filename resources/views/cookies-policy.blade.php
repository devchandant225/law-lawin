...
@section('meta_tags')
    <x-meta-tags :title="$publication->metatitle ?: $publication->title . ' - Cookies Policy'" :description="$publication->metadescription ?: $publication->excerpt" :keywords="$publication->metakeywords" :image="$publication->feature_image_url" type="article" :post="$publication" />
@endsection
...
@section('head')
    ...
    @php
        $schemaJson = $publication->google_schema_json ?? [];
