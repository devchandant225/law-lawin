...
@section('head')
    ...
    @if ($language->google_schema_json)
        <script type="application/ld+json">{!! $language->google_schema_json !!}</script>
    @endif
@endsection
    ...
    <section class="page-header background-black">
        <div class="container">
            <div class="text-center">
                <h1 class="sec-title__title--white">{{ $language->title }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('languages.index') }}">Languages</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ Str::limit($language->title, 40) }}
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="publication-header-card card mb-40">
                        ...
                        <div class="card-body p-4 p-md-5">
                            <h2 class="publication-summary-title mb-3">{{ $language->title }}</h2>
                    ...
                    @if (!empty($teamMembers) && count($teamMembers) > 0)
                        <section id="team-section" class="card team-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: rgb(39, 37, 37);">Meet our multilingual legal professionals
                                </p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-3">
                    ...
                    @if ($faqs->count() > 0)
                        <section id="faqs-section" class="card faq-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: rgb(39, 37, 37);">Common questions about our language services
                                </p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                    ...
                    <section class="card cta-section mt-40"
                        ...
                        <div class="card-body text-center p-5">
                            <div class="icon-circle background-base mb-4 mx-auto">
                                <i class="fas fa-globe" style="color: var(--procounsel-white);"></i>
                            </div>
                            <h3 class="cta-title mb-4">Need Legal Services in This Language?</h3>
                            <p class="cta-description mb-4">
                                Our multilingual legal experts are ready to assist you in your preferred language.
                                Get professional legal support with clear communication.
                            </p>
                            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                                <a href="{{ url('/contact') }}" class="procounsel-btn">
                                    <i><i class="fas fa-comments me-2"></i>Get In Touch</i>
                                    <span><i class="fas fa-comments me-2"></i>Get In Touch</span>
                                </a>
                                <a href="{{ route('languages.index') }}" class="btn btn-outline-light btn-lg">
                                    <i class="fas fa-globe me-2"></i>More Languages
                                </a>
                            </div>
                        </div>
                    </section>
