...
@section('head')
    <x-meta-tags :title="$learningCenter->metatitle ?: $learningCenter->title . ' - Learning Resource'" :description="$learningCenter->metadescription ?: $learningCenter->excerpt" :keywords="$learningCenter->metakeywords" :image="$learningCenter->feature_image_url" type="article" :post="$learningCenter" />
    ...
    @if ($learningCenter->google_schema_json)
        <script type="application/ld+json">{!! $learningCenter->google_schema_json !!}</script>
    @endif
@endsection

@section('content')
    {{-- Page Banner --}}
    <x-page-banner :title="$learningCenter->title" :breadcrumbs="[
        ['label' => 'Home', 'url' => url('/')],
        ['label' => 'Learning Center', 'url' => route('learning-center.index')],
        ['label' => $learningCenter->title],
    ]" />
    ...
    <section class="pt-4">
                ...
                <div class="w-full lg:w-3/4 px-4">
                        ...
                        <section id="team-section"
                            ...
                            <div class="mb-8 px-3">
                                <h3 class="text-2xl font-bold text-accent mb-4">
                                    ...
                                    Learning Instructors & Support Team
                                </h3>
                            </div>
                    ...
                    <div class="px-4 py-2">
                        ...
                        <p class="text-gray-600 font-normal text-sm mb-2">
                            {{ $member['designation'] ?? 'Learning Instructor' }}
                        </p>
        ...
        <!-- Quick Learning Support Section -->
        <section class="bg-accent rounded-lg shadow-xl overflow-hidden cta-section mt-10 p-6">
            ...
            <div class="text-left">
                <h3 class="text-xl font-bold text-white mb-3 underline decoration-white">
                    Need support with your learning journey?
                </h3>
                
                <div class="text-white text-base mb-4">
                    @if ($primaryPhone)
                        <p class="mb-2">
                            <span class="font-medium">You can directly call to our learning support team:</span> 
    ...
    @if($relatedLearningCenter->count() > 0)
        <x-page-section-title title="<span>Related Learning Resources</span>" />
        <section class="py-16">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    @foreach($relatedLearningCenter->take(4) as $related)
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="p-4">
                                ...
                                <h4 class="text-lg font-bold text-gray-900 mb-2 hover:text-primary transition-colors">
                                    <a href="{{ route('learning-center.show', $related->slug) }}">
