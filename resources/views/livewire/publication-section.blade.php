        ...
        <div class="container" style="position: relative; z-index: 1; padding: 80px 15px;">
                            ...
                            ">
                                ...
                                @if(!empty($search))
                                    <div class="search-info mt-2" style="color: #fff; font-size: 14px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8);">
                                        <span>{{ $publications->count() }} publication(s) found for "{{ $search }}"</span>
                                        <button 
            ...
            @else
                <div class="text-center py-5" wire:loading.remove.delay>
                    @if(!empty($search))
                        <h4 style="color: #fff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">No publications found for "{{ $search }}"</h4>
                        <p style="color: #fff; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8);">Try searching with different keywords or browse all publications.</p>
                        <button 
                            wire:click="$set('search', '')"
                    ...
                    @else
                        <h4 style="color: #fff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">No publications available at the moment.</h4>
                        <p style="color: #fff; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8);">Please check back later for our latest publications and resources.</p>
                    @endif
                </div>
            @endif
