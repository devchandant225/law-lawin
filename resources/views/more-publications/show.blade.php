...
@section('meta_tags')
    <x-meta-tags :title="$morePublication->metatitle ?: $morePublication->title . ' - More Publications'"
        :description="$morePublication->metadescription ?: $morePublication->excerpt" :keywords="$morePublication->metakeywords"
        :image="$morePublication->feature_image_url" type="article" :post="$morePublication" />
@endsection
...
@section('head')
    ...
    @php
        $schemaJson = $morePublication->google_schema_json ?? [];
    ...
    <section class="page-header background-black">
        <div class="container">
            <div class="text-center">
                <h1 class="sec-title__title--white">{{ $morePublication->title }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('more-publications.index') }}">More Publications</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ Str::limit($morePublication->title, 40) }}
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div style="padding: 0 12px;" class="">
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    <!-- More Publication Header -->
                    <div class="publication-header-card card mb-40">
                        @if ($morePublication->feature_image_url)
                            <div class="publication-image-wrapper">
                                <img src="{{ $morePublication->feature_image_url }}" alt="{{ $morePublication->feature_image_alt ?: $morePublication->title }}"
                                    class="card-img-top publication-feature-image">
                            </div>
                        @endif
                        <div class="card-body p-4 p-md-5">
                            <h2 class="publication-summary-title mb-3">{{ $morePublication->title }}</h2>
                            @if ($morePublication->description)
                                <div class="publication-content">
                                    {!! $morePublication->description !!}
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    @if ($faqs->count() > 0)
                        <section id="faqs-section" class="card faq-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: rgb(39, 37, 37);">Common questions about this more publication
                                </p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                    ...
                    <section class="card cta-section mt-40"
                        ...
                        <div class="card-body text-center p-5">
                            ...
                            <p class="cta-description mb-4">
                                Have questions about this more publication or need specific legal guidance? Our experienced team
                                is here to help.
                            </p>
                            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                                ...
                                <a href="{{ route('more-publications.index') }}" class="btn btn-outline-light btn-lg">
...
@push('styles')
    <style>
        /* More Publication Page Custom Styles */
