                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                                ...
                                @else
                                    <div class="w-full h-48 bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center">
                            ...
                            <h4 class="flex items-center gap-3 text-xl font-bold text-primary mb-6">
                                <div
                                    ...
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 7 10 0">
                                        </path>
                                    </svg>
                                </div>
                                More Practice Areas
