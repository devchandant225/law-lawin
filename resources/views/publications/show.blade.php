...
@section('content')
                    ...
                    <div class="publication-header-card bg-white overflow-hidden">
                        ...
                        @else
                            ...
                            <div class="publication-gradient-header">
                                <div
                                    class="bg-primary h-[28rem] w-full flex items-center justify-center relative overflow-hidden">
                                    <!-- Background Pattern -->
                                    <div class="absolute inset-0 opacity-20">
                                        <div
                                            class="absolute top-10 left-10 w-32 h-32 bg-white rounded-full blur-3xl opacity-30 animate-pulse">
                                        </div>
                                        <div
                                            class="absolute bottom-10 right-10 w-40 h-40 bg-white rounded-full blur-3xl opacity-20 animate-pulse delay-1000">
                                        </div>
                                        <div
                                            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-white rounded-full blur-3xl opacity-10">
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                                        <h1
                                            class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight drop-shadow-lg">
                                            {{ $publication->title }}
                                        </h1>
    ...
    <section class="bg-accent rounded-lg shadow-xl overflow-hidden cta-section mt-10 p-6">
        @php
            ...
            $phoneNumbers = [];
            if ($globalProfile) {
                $phoneNumbers = array_filter([$globalProfile->phone1 ?? null, $globalProfile->phone2 ?? null]);
            }
        ...
        <div class="text-left">
            ...
            <div class="text-white text-base mb-4">
                ...
                @endif
                <p class="mb-4">
                    <span class="font-medium">Even can call or drop a text through What's app , Viber, Telegram and We Chat
                        at the same number.</span>
                </p>
            </div>
            ...
            <div class="flex items-center gap-3 mb-4">
                @if ($globalProfile && $globalProfile->whatsapp)
                    <a href="{{ $globalProfile->whatsapp }}" target="_blank"
                        class="bg-white p-3 rounded-lg hover:scale-105 transition-transform duration-200">
                        <i class="fab fa-whatsapp text-green-500 text-2xl"></i>
                    </a>
                @elseif ($cleanPhone)
                    <a href="https://wa.me/{{ ltrim($cleanPhone, '+') }}" target="_blank"
                        class="bg-white p-3 rounded-lg hover:scale-105 transition-transform duration-200">
                        <i class="fab fa-whatsapp text-green-500 text-2xl"></i>
                    </a>
                @endif
                ...
                @elseif ($cleanPhone)
                    <a href="viber://chat?number={{ $cleanPhone }}" target="_blank"
                        class="bg-white p-3 rounded-lg hover:scale-105 transition-transform duration-200">
                        <i class="fab fa-viber text-purple-600 text-2xl"></i>
                    </a>
                @endif
                ...
                @if ($cleanPhone)
                    <a href="https://t.me/{{ ltrim($cleanPhone, '+') }}" target="_blank"
                        class="bg-white p-3 rounded-lg hover:scale-105 transition-transform duration-200">
                ...
                <div class="text-white text-base">
                    <p class="mb-2">
                        ...
                        <a href="mailto:{{ $emailAddress }}"
                            class="font-bold hover:underline text-white">{{ $emailAddress }}</a>
                        @if ($globalProfile && $globalProfile->email2)
                            , <a href="mailto:{{ $globalProfile->email2 }}"
                                class="font-bold hover:underline text-white">{{ $globalProfile->email2 }}</a>
                        @endif
                    </p>
                </div>
            @endif
