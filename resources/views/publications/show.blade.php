            ...
            <div class="text-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ Str::limit($publication->title, 40) }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div style="padding: 0 12px;" class="">
            <div class="row">
                                        ...
                                        @foreach($tableOfContents as $content)
                                            <a href="#toc-section-{{ $content->id }}" 
                                               ...
                                               data-target="toc-section-{{ $content->id }}">
                                                <span class="toc-number d-flex align-items-center justify-content-center me-3">
                ...
                <div class="col-12 col-lg-9">
                    ...
                    @if(!empty($teamMembers) && count($teamMembers) > 0)
                        <section id="team-section" class="card team-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: var(--procounsel-text-dark);">Meet the experts who contributed to this publication</p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-3">
                    ...
                    @if($faqs->count() > 0)
                        <section id="faqs-section" class="card faq-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: var(--procounsel-text-dark);">Common questions about this publication</p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                                    ...
                                    @foreach($faqs as $faq)
                                        <div class="accordion-item mb-3">
                                            <h6 class="accordion-header" id="faq-heading-{{ $faq->id }}">
                                                <button class="accordion-button collapsed faq-toggle d-flex align-items-center" 
                                                        type="button" 
                                                        data-bs-toggle="collapse" 
                                                        data-bs-target="#faq-{{ $faq->id }}" 
                                                        aria-expanded="false" 
                                                        aria-controls="faq-{{ $faq->id }}">
                                                    <i class="fas fa-question-circle me-3" style="color: var(--procounsel-base);"></i>
                                                    {{ $faq->question }}
                                                </button>
                                            </h6>
                                            <div id="faq-{{ $faq->id }}" 
                    ...
                    <section class="card cta-section mt-40" style="background: linear-gradient(135deg, var(--procounsel-primary) 0%, var(--procounsel-base) 100%);">
            ...
            link.addEventListener('click', function(e) {
                ...
                if (targetSection) {
                    ...
                    if (window.innerWidth < 992) {
                        const collapse = bootstrap.Collapse.getInstance(document.getElementById('tocNavigation'));
                        if (collapse) {
                            collapse.hide();
                        }
                    }
        ...
        const observer = new IntersectionObserver(function(entries) {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    const correspondingLink = document.querySelector(`[data-target="${entry.target.id}"], [href="#${entry.target.id}"]`);
