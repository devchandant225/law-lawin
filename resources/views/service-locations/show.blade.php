    ...
    <section class="page-header background-black">
        <div class="container">
            <div class="text-center">
                <h1 class="sec-title__title--white">{{ $serviceLocation->title }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('service-locations.index') }}">Service Locations</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ Str::limit($serviceLocation->title, 40) }}
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="publication-header-card card mb-40">
                        ...
                        <div class="card-body p-4 p-md-5">
                            <h2 class="publication-summary-title mb-3">{{ $serviceLocation->title }}</h2>
                            @if ($serviceLocation->description)
                    ...
                    @if (!empty($teamMembers) && count($teamMembers) > 0)
                        <section id="team-section" class="card team-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: rgb(39, 37, 37);">Meet the legal professionals serving
                                    this location</p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                                <div class="row g-3">
                    ...
                    @if ($faqs->count() > 0)
                        <section id="faqs-section" class="card faq-section mt-40">
                            <div class="card-header background-primary text-white text-center">
                                ...
                                <p class="mb-0 mt-2" style="color: rgb(39, 37, 37);">Common questions about this service location
                                </p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                    ...
                    <section class="card cta-section mt-40"
                        ...
                        <div class="card-body text-center p-5">
                            <div class="icon-circle background-base mb-4 mx-auto">
                                <i class="fas fa-map-marker-alt" style="color: var(--procounsel-white);"></i>
                            </div>
                            <h3 class="cta-title mb-4">Need Legal Services at This Location?</h3>
                            <p class="cta-description mb-4">
                                Looking for expert legal assistance at this location? Our experienced team is ready to help you
                            ...
                            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                                ...
                                <a href="{{ route('service-locations.index') }}" class="btn btn-outline-light btn-lg">
                                    <i class="fas fa-map me-2"></i>More Locations
                                </a>
                            </div>
                        </div>
                    </section>
...
@push('styles')
    <style>
        /* Service Location Page Custom Styles */
