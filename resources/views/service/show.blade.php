                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-6 sm:p-10 border border-gray-200 shadow-lg animate-fade-in-up">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex items-start gap-4">
                                <div class="w-12 h-12 bg-yellow-600 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="lg:sticky lg:top-8 space-y-6">
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-200 animate-fade-in-up">
                            <h4 class="flex items-center gap-3 text-xl font-semibold text-blue-900 mb-6">
                                <i class="fas fa-list-ul text-yellow-600"></i>
                                More Services
                            </h4>
                            <div class="space-y-4">
                                    ...
                                    @foreach ($relatedServices as $relatedService)
                                        <div class="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                                            <div class="w-20 h-16 rounded-lg overflow-hidden flex-shrink-0">
                                                ...
                                                @else
                                                    <div class="w-full h-full bg-gradient-to-br from-yellow-600 to-blue-900 flex items-center justify-center">
                                                        <i class="fas fa-briefcase text-white text-xl"></i>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="flex-1">
                                                <h6 class="font-semibold text-blue-900 hover:text-yellow-600 transition-colors duration-300 leading-tight">
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-200 animate-fade-in-up">
                            ...
                            <form class="space-y-5" action="{{ route('contact.submit') }}" method="POST">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="fullname" name="fullname" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-yellow-600 focus:ring-4 focus:ring-yellow-600/25 outline-none transition-all duration-300" placeholder="Enter your full name" required>
                                </div>
                                
                                <div>
                                    <label for="email" class="block text-blue-900 font-semibold text-sm mb-2">Email *</label>
                                    <input type="email" id="email" name="email" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-yellow-600 focus:ring-4 focus:ring-yellow-600/25 outline-none transition-all duration-300" placeholder="Enter your email" required>
                                </div>
                                
                                <div>
                                    <label for="phone" class="block text-blue-900 font-semibold text-sm mb-2">Phone</label>
                                    <input type="tel" id="phone" name="phone" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-yellow-600 focus:ring-4 focus:ring-yellow-600/25 outline-none transition-all duration-300" placeholder="Enter your phone number">
                                </div>
                                
                                <div>
                                    <label for="subject" class="block text-blue-900 font-semibold text-sm mb-2">Subject *</label>
                                    <input type="text" id="subject" name="subject" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-yellow-600 focus:ring-4 focus:ring-yellow-600/25 outline-none transition-all duration-300" placeholder="Enter subject" value="Inquiry about {{ $service->title }}" required>
                                </div>
                                
                                <div>
                                    <label for="message" class="block text-blue-900 font-semibold text-sm mb-2">Message *</label>
                                    <textarea id="message" name="message" rows="4" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-yellow-600 focus:ring-4 focus:ring-yellow-600/25 outline-none transition-all duration-300 resize-none" placeholder="Write your message here..." required></textarea>
                                </div>
                                
                                <button type="submit" class="w-full bg-gradient-to-r from-yellow-600 to-blue-900 text-white font-semibold py-3 px-6 rounded-xl hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2">
