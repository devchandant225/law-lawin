...
@section('content')
    ...
    <section class="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-24 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
                    ...
                    <ol class="inline-flex items-center space-x-2 text-purple-300">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="{{ route('services.index') }}"
                                class="ml-2 hover:text-white transition-colors duration-300">Services</a>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <span class="ml-2 text-white font-medium">{{ $service->title }}</span>
                        </li>
                    </ol>
                </nav>
            ...
            <!-- Title -->
            <h2
                class="text-3xl md:text-4xl font-bold mb-6 leading-tight bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
                {{ $service->title }}
            </h2>
        </div>
        ...
        <div class="container mx-auto">
            <div class="grid xl:grid-cols-4 gap-3">
                ...
                <div class="xl:col-span-3">
                    ...
                    <!-- Key Benefits -->
                    <div
                        class="bg-gradient-to-br from-purple-50 to-blue-50 rounded-3xl shadow-xl border border-purple-100 p-8 lg:p-12 mb-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div
                                ...
                                <div
                                    class="flex-shrink-0 w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-1">Expert Legal Guidance</h4>
                                    <p class="text-gray-600 text-sm">Professional advice from experienced legal experts</p>
                                </div>
                            </div>
                            <div
                                class="flex items-start space-x-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-1">Confidential Service</h4>
                                    <p class="text-gray-600 text-sm">Complete privacy and confidentiality guaranteed</p>
                                </div>
                            </div>
                            <div
                                class="flex items-start space-x-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-1">Fast Resolution</h4>
                                    <p class="text-gray-600 text-sm">Quick and efficient handling of your legal matters</p>
                                </div>
                            </div>
                            <div
                                class="flex items-start space-x-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
                                <div
                                    class="flex-shrink-0 w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-1">Professional Team</h4>
                                    <p class="text-gray-600 text-sm">Experienced legal professionals at your service</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sticky top-8 space-y-8">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6">
                            ...
                            {{-- <div class="mt-8 pt-6 border-t border-gray-200">
                                <h5 class="font-semibold text-gray-900 mb-4">Quick Contact</h5>
                                <div class="space-y-3">
                                    <a href="{{ url('/contact') }}"
                                        class="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium rounded-xl transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 shadow-lg">
                                    ...
                                    <a href="tel:+1234567890"
                                        class="w-full inline-flex items-center justify-center px-4 py-3 bg-gray-100 text-gray-700 font-medium rounded-xl transform transition-all duration-300 hover:bg-gray-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        ...
                        <!-- Share Card -->
                        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6">
                            <h4 class="text-xl font-bold text-gray-900 mb-4">Share This Service</h4>
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <!-- Viber -->
                                <a href="viber://forward?text={{ urlencode($service->title . ' - ' . request()->url()) }}"
                                    target="_blank"
    ...
    @if ($relatedServices->count() > 0)
        <section class="py-10 bg-gradient-to-br from-gray-50 to-purple-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    <div
                        class="inline-block mb-4 px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full text-sm font-semibold tracking-wide">
                        Explore More
                    </div>
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                        Related <span
                            class="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Services</span>
                    </h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Discover other professional services that might be relevant to your legal needs
                    </p>
                </div>
                    ...
                    @foreach ($relatedServices as $relatedService)
                        <div class="group">
                            <div
                                ...
                                <div class="relative overflow-hidden h-48 bg-gradient-to-br from-purple-100 to-blue-100">
                                    ...
                                    @else
                                        <div class="flex items-center justify-center w-full h-full">
                                            <svg class="w-16 h-16 text-purple-400/50" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                            </svg>
                                ...
                                <div class="p-6">
                                    <h3
                                        class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-purple-600 transition-colors duration-300">
                                    ...
                                    <a href="{{ route('service.show', $relatedService->slug) }}"
                                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-sm font-semibold rounded-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
