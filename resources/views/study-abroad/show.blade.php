                ...
                <div class="w-full lg:w-1/4 px-4 hidden lg:block">
                    @if ($tableOfContents->count() > 0)
                        ...
                        <div class="sticky top-[5rem] z-50 transition-all duration-300" id="tocSidebar">
                            <div
                                class="bg-white rounded-lg shadow-lg overflow-hidden toc-navigation max-h-[calc(100vh-7rem)] border border-gray-200">
                                ...
                                <div class="p-0">
                                    <nav
                                        class="toc-nav max-h-[calc(100vh-15rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                        @foreach ($tableOfContents as $content)
                                            <a href="#toc-section-{{ $content->id }}"
                                                ...
                                                <span
                                                    class="flex-1 group-hover:pl-1 transition-all duration-300">{{ Str::limit($content->title, 100) }}</span>
                                                <i
                                                    class="fas fa-chevron-right opacity-0 group-hover:opacity-100 ml-2 transform scale-75 group-hover:scale-100 transition-all duration-300"></i>
                                            </a>
                                        @endforeach
                                    </nav>
                                </div>
                        ...
                        <div
                            ...
                            @if ($related->feature_image_url)
                                <div class="h-48 bg-gray-200 overflow-hidden">
                                    <img src="{{ $related->feature_image_url }}" alt="{{ $related->title }}"
