                                    ...
                                    <div class="relative inline-block">
                                        @if($team->image_url)
                                            <img src="{{ $team->image_url }}" alt="{{ $team->name }}" 
                                                 class="w-36 h-48 md:w-44 md:h-56 object-contain rounded-2xl border-4 border-white/30 shadow-2xl group-hover:scale-105 transition-transform duration-300">
                                        @else
